    ...
    >
      ...
      >
        <Box direction="column" gap="medium" pad={{ horizontal: "xlarge" }}>
          <Box
            direction={width < 560 ? "column" : "row"}
            gap="medium"
            justify="between"
          >
            <Box>
          ...
          <Box direction={width < 560 ? "column" : "row"} gap="medium">
            <Box>
          ...
          <Box>
            <Text style={{ fontFamily: "sans-serif" }}>Description</Text>
            <TextArea
              required
              placeholder="type here"
              style={{ fontFamily: "sans-serif", fontWeight: "normal" }}
          ...
          >
            Already Have an Account ? <Link to="loginWorker">Login</Link>
          </Text>
        </Box>
      </Form>
    </Box>
